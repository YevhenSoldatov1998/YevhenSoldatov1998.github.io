...
$(function(){$("#mymenu").mmenu({offCanvas:{position:"left"},extensions:["theme-black","fx-panels-none","fx-listitems-fade","effect-menu-slide","pagedim-black"],navbar:{title:'<img src="img/logo/logo-1.svg" alt="Салон красоты">'}});var e=$("#mymenu").data("mmenu");function s(){$(".carousel-services-item").each(function(){var e=$(this),s=e.find(".carousel-services-content").outerHeight();e.find(".carousel-services-image").css("min-height",s)})}function i(){$(".carousel-services-content").equalHeights()}e.bind("open:start",function(){setTimeout(function(){$(".hamburger").addClass("is-active")},300)}),e.bind("close:before",function(){setTimeout(function(){$(".hamburger").removeClass("is-active")},300)}),$(".carousel-services").on("initialized.owl.carousel",function(){setTimeout(function(){s()})}),$(".carousel-services").owlCarousel({nav:!0,smartSpeed:900,navText:['<i class="fa fa-angle-double-left"></i>','<i class="fa fa-angle-double-right"></i>'],responsiveClass:!0,dots:!1,responsive:{0:{items:1},800:{items:2},1100:{items:3}}}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".top").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),s(),$(".carousel-services-composition .h3").each(function(){var e=$(this);e.html(e.html().replace(/(\S+)\s*$/,"<span>$1</span>"))}),$("section .h2").each(function(){var e=$(this);e.html(e.html().replace(/^(\S+)/,"<span>$1</span>"))}),i(),window.onresize=function(){i()},$("select").selectize({}),$("form.callback").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(e).find(".success_hidden").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){$(e).find(".success_hidden").removeClass("active").fadeOut(),e.trigger("reset")},3e3)}),!1}),$(".reviews").owlCarousel({loop:!0,items:1,smartSpeed:800,autoHeight:!0}),$(".partners").owlCarousel({loop:!0,items:5,smartSpeed:800,nav:!0,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],responsive:{0:{items:3},800:{items:4},1100:{items:5}}}),$(".fotorama").fotorama({width:"100%",nav:"thumbs",thumbwidth:"110.5",keyboard:"true",thumbborderwidth:"5",transition:"dissolve",thumbwidth:"70px"})}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")});